...
func (invs Intervals) Len() int { return len(invs) }
func (invs Intervals) Swap(i, j int) { invs[i], invs[j] = invs[j], invs[i] }
func (invs Intervals) Less(i, j int) bool { 
	return invs.LessByEnd(i, j)
	// return invs.LessByFront(i, j)
}
func (invs Intervals) LessByEnd(i, j int) bool { 
	return invs[i][1] < invs[j][1]
}
func (invs Intervals) LessByFront(i, j int) bool { 
...
func eraseOverlapIntervals(intervals [][]int) int {
	...
	return GreedyMethod(intervals)
	// return DPMethod(intervals)
}

func GreedyMethod(intervals [][]int) int {
	res := 0
...
func DPMethod(intervals [][]int) int {
	max := 1
